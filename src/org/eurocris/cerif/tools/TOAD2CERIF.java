...
public class TOAD2CERIF {
	...
	public static void main(String argv[]) {
		...
		try {
			...
			Element cfClassSchema = createSubElement(entityTypesXML, cerif, "cfClassScheme");
			...
			createSubElement(entityTypesXML, cfClassSchema, "cfClassSchemeId", CERIF_ENTITY_TYPES_UUID );
			addLangTrans(createSubElement(entityTypesXML, cfClassSchema, "cfName", "CERIF Entity Types"));
			addLangTrans(createSubElement(entityTypesXML, cfClassSchema, "cfDescr", "This scheme contains the available classification for the CERIF Entities"));
...
//							"cfClassSchemeId1", CERIF_ENTITY_TYPES_UUID);
					...
					createSubElement(entityTypesXML, cfClassClass, 
							"cfClassId2", cleanTOADUUID(id));
					createSubElement(entityTypesXML, cfClassClass, 
							"cfClassSchemeId2", CERIF_ENTITIES_UUID);
					
					createSubElement(entityTypesXML, cfClassClass, 
							"cfClassId", CERIF_DMF_APPLICABLE_UUID);
					createSubElement(entityTypesXML, cfClassClass, 
							"cfClassSchemeId", CERIF_DATAMODEL_FACTS_UUID);
				}
			}
			...
			StreamResult result = new StreamResult(
					new File(outputFolder, "CERIF_Entity_Types--" + CERIF_ENTITY_TYPES_UUID+ ".xml"));
